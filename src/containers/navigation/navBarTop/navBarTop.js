...
class NavBarTop extends Component {
  state = {
    ...
    searchKeyword: null,
    canUseCategory:
      this.props.canUseCategory !== undefined
        ? this.props.canUseCategory
        : true,
    canSearch: this.props.canSearch !== undefined ? this.props.canSearch : true,
    canOpenProfile:
      this.props.canOpenProfile !== undefined ? this.props.canOpenProfile : true
  };
